...
<body>
  ...
  <div class="main">
    ...
    <div class="main1">
        <div class="container">
            <h1 class="mt-5">Daftar Alat</h1>
            <a href="add-alat.php" class="btn btn-success mb-3">Tambah Alat</a>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td>{$row['longitude']}</td>
                                    <td>
                                        <a href='edit-alat.php?id={$row['id']}' class='btn btn-primary btn-sm'>Edit</a>
                                        <a href='delete-alat.php?id={$row['id']}' class='btn btn-danger btn-sm'>Delete</a>
                                    </td>
                                  </tr>";
                        }
                    } else {
